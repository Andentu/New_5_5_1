namespace New_5_5_1
{
    internal class Program
    {
        ...
        static void Echo2(string saidworld, int deep) //Второй метод, для усовершениствования эха
        {
            ...
            Console.BackgroundColor = (ConsoleColor) numb; //Окрашивание фона в определенный цвет
            Console.ForegroundColor = (ConsoleColor) numb - 1; //Окрашивание символов в определенный цвет
            
            Console.WriteLine("..." + modif); //Выводим значение переменной modif с учетом удаленных символов
            
            if (deep > 1 && modif.Length > 2) //Условие вызова метода (Добавил доп условие, чтобы вызов прекращался сразу, как останется 1 символ)
            {
